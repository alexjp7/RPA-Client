    ...
    public class MonsterFactory
    {
        ...
        **************************************************************/
        private Monster getMonster(string type, string name)
        {
            ...
            Monster newMonster = getInstance(monsterType, name);
        ...
        **************************************************************/
        ...
        @param - monsterType: the type name as specified in the MonsterTypes
        namespace.
        @param - name: name of monster pre-generated by party leader

        @return - a monster instance through a passed in class name
        **************************************************************/
        public Monster getInstance(Type monsterType, string name)
        {
            return Activator.CreateInstance(monsterType, new object[] {name}) as Monster;
        }
    }
}
